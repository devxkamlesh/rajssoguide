        ...
        <section className="mb-8">
          ...
          <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-4">
            ...
            <p className="text-zinc-700 mb-2">
              Email: <a href="mailto:privacy@rajssoguide.in" className="text-amber-700 underline">privacy@rajssoguide.in</a>
            </p>
      ...
      <article className="prose prose-zinc lg:prose-lg">
        ...
        <section className="mb-8">
          ...
          <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-4">
            ...
            <p className="text-zinc-700 mb-2">
              ईमेल: <a href="mailto:privacy@rajssoguide.in" className="text-amber-700 underline">privacy@rajssoguide.in</a>
            </p>
            <p className="text-zinc-700">
